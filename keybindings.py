...
bindings = {
    ...
    ctrl+u:"who",    alt+u:"ie",     ctrl+U:"ea",     alt+U:"ent",
    ctrl+i:"would",  alt+i:"ing",    ctrl+I:"ang",    alt+I:"ong",
    ctrl+o:"which",  alt+o:"ou",     ctrl+O:"uou",    alt+O:"ough",
    ctrl+p:"while",  alt+p:"ple",    ctrl+P:"pre",    alt+P:"per",
